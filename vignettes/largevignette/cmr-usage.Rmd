...
local=cmr(cmrdata_sim,input_sim,method="local",cores=parallel::detectCores())
...
spatial=cmr(cmrdata_sim,input_sim,method="spatial",cores=parallel::detectCores())
...
pseudobullseye(local$mbf); title(main="true")
pseudobullseye(spatial$mbf); title(main="true")
```
